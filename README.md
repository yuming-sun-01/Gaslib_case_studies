...
Initial condition: in initialization_tools
...
Time transformation and discretization settings: in infNMPC_options.py
L = 32
nfe_inf = 5
ncp_inf = 3
...
Terminal constraints: in infinite_block.py
terminal_error = sum(
...
Stability constraints: in stability.py
