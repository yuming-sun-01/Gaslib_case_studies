"""
plot_paper.py — paper-ready 2x3 E-NMPC comparison plot for the Test network.
...
# (filename, slice). slice=None means use all rows.
COLUMNS = [
    ("f_enmpc_cycle_1.xlsx",      None),
    ("f_enmpc_cycle_10.xlsx",     None),
    ("Inf_enmpc_felement=1.xlsx", None),
]
