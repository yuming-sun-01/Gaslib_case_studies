"""Plot Gaslib40 gas network schematic and cyclic demand profile."""
...
NETWORK_FILE = os.path.join(BASE_DIR, "data", "data_files", "Gaslib_40", "networkData.xlsx")
INPUT_FILE   = os.path.join(BASE_DIR, "data", "data_files", "Gaslib_40", "inputData.xlsx")

NUM_TIME_PERIODS = 1
TIME_LENGTH      = 25   # 0-24 hrs
T_MAX            = 24.0
